...
public class BoardView {
    ...
    private BoardView(){}
    // 3. 내부의 객체를 외부로부터 직접 접근이 아닌 간접 접근할 수 있도록 getter 함수를 만들어준다.
    ...
    Scanner scan = new Scanner(System.in); //입력객체
     ...
     public void mainPage(){ //view 시작함수
        while (true){
    ...
    // 2.게시물 출력 함수
    void boardPrint(){
        // 1. 컨트롤러에게 모든 게시물(Board객체) 정보를 요청한다.
        //BoardController boardController = new BoardController();// 객체가 왜 필요해? 다른 클래스의 메소드()를 호출하기 위해서는 객체가 필요하다.
