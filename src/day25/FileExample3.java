...
public class FileExample3 {
    public static void main(String[] args) {
        ...
        try {
            // 생각해보기 :
            // 1.키보드로부터 입력받은 문자열을 'day25'폴더내 test2.txt에 저장하시오.
            // [1] 입력 객체
            ...
            // 2. 'day25' 폴더내 test2.txt에 저장된 (문자열) 바이트를 읽어 콘솔에 출력하시오.
            ...
            //byte[] bytes = new byte[1000]; // 1000개의 바이트( 영문 1글자당 1바이트 , 한글 1글자당 2바이트 ) 를 저장할 수 있는 배열 선언
            // 현재 읽어올 파일의 용량을 몰라서 임의로 1000개로 한다.

            // [2-2] 읽어올 파일을 용량/바이트개수를 확인 후 파일의 용량만큼 배열 선언
            File file = new File("./src/day25/test2.txt");
            System.out.println(file.isFile()); // true / 지정한 경로의 파일이 존재하는지 반환 함수
            System.out.println(file.getName()); // test2.txt / 지정한 파일의 이름 반환 함수
            System.out.println(file.length()); // 반환타입 long / 지정한 파일의 용량(바이트) 반환 함수
            ...
            // ! : 만약에 파일 객체가 입/출력중일때 외부적인 요소로 문제가 발생하면 예외 발생
